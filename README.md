...
- **Technical Analysis**: 
  - Katerina Bischel (Sediment Quality Analysis) 
  - Abigail Guilliat (Vulnerability Mapping)
  - Nadav Kempinski (Water Quality Analysis, Hazard Quotient Calculation)
  - Elijah Khan (Air Quality Modeling)
  - Jackson Mills (Regional Mapping, Water Quality Analysis)
- **Shiny App Development**: Jackson Mills, Nadav Kempinski
...
```bash
git clone https://github.com/nadavkempinski/pilcomayo_water_sediment_quality_app.git
```
